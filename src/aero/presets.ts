...
export const PRESETS: RotorPreset[] = [
  ...
  { id: 'darrieus', nameUA: 'Darrieus H 3 м', nameEN: 'Darrieus H 3 m', category: 'vawt', materialId: 'alu',
    ...
    geometry: { airfoilId: 'naca0018', rootRadius: 0.1, tipRadius: 1.5, chordRoot: 0.25, chordTip: 0.25, twistRoot: 0, twistTip: 0, pitch: 0, nBlades: 3, twistLaw: 'linear' },
  ...
  { id: 'gorlov', nameUA: 'Gorlov helical 2 м', nameEN: 'Gorlov helical 2 m', category: 'vawt', materialId: 'alu',
    ...
    geometry: { airfoilId: 'naca0018', rootRadius: 0.1, tipRadius: 1.0, chordRoot: 0.20, chordTip: 0.20, twistRoot: 0, twistTip: 0, pitch: 0, nBlades: 3, twistLaw: 'linear' },
  ...
  { id: 'qr5', nameUA: 'QuietRevolution QR5', nameEN: 'QuietRevolution QR5', category: 'vawt', materialId: 'cfrp',
    ...
    geometry: { airfoilId: 'naca0015', rootRadius: 0.15, tipRadius: 1.55, chordRoot: 0.30, chordTip: 0.30, twistRoot: 0, twistTip: 0, pitch: 2, nBlades: 3, twistLaw: 'linear' },
  ...
  { id: 'eggbeater', nameUA: 'Phi Darrieus (eggbeater)', nameEN: 'Phi Darrieus (eggbeater)', category: 'vawt', materialId: 'alu',
    ...
    geometry: { airfoilId: 'naca0015', rootRadius: 0.1, tipRadius: 2.0, chordRoot: 0.22, chordTip: 0.22, twistRoot: 0, twistTip: 0, pitch: 0, nBlades: 2, twistLaw: 'linear' },
